        ...
        qb.table( "my_posts" ).insert( [
            {
                ...
                "published_date": createDateTime( 2017, 07, 28, 02, 07, 00 )
            },
            {
                "post_pk": 523526,
                "user_id": 1,
                "body": "My second awesome post body",
                "created_date": createDateTime( 2017, 07, 28, 02, 07, 36 ),
                "modified_date": createDateTime( 2017, 07, 28, 02, 07, 36 ),
            ...
            },
            {
                ...
                "created_date": createDateTime( 2017, 07, 30, 07, 00, 22 ),
                "modified_date": createDateTime( 2017, 07, 30, 07, 00, 22 ),
                "published_date": { "value": "", "null": true }
            },
            {
                "post_pk": 321,
                ...
                "created_date": createDateTime( 2017, 08, 28, 14, 22, 22 ),
                "modified_date": createDateTime( 2017, 08, 28, 14, 22, 22 ),
                "published_date": createDateTime( 2017, 08, 28, 14, 22, 22 )
            }
        ] );
    }
